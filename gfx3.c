// gfx3.c Edited by: Nicholas Ward & Dina Vu
...
// Temporarily turn-off auto-repeat for the keyboard //
void gfx_repeat_on()
{
	int auto_repeat_mode=XAutoRepeatOn(gfx_display);
}

// Restore auto-repeat for the keyboard //
void gfx_repeat_off()
{
	int auto_repeat_mode=XAutoRepeatOff(gfx_display);
}
...
{
	Font font = XLoadFont(gfx_display, "-adobe-courier-bold-r-normal--24-240-75-75-m-150-iso8859-1");
